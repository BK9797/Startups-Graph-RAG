...
This is the schema the fixed Cypher query templates are written against
(see `app/core/cypher_library.py` for the templates themselves, and
`CYPHER.md` at the project root for the full, documented catalog of
every query the API can run).
