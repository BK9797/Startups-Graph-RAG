...
class Settings(BaseSettings):
    ...
    groq_cypher_model: str = Field(default="llama-3.3-70b-versatile", alias="GROQ_CYPHER_MODEL")
    groq_answer_model: str = Field(default="llama-3.3-70b-versatile", alias="GROQ_ANSWER_MODEL")
    groq_temperature_cypher: float = Field(default=0.0, alias="GROQ_TEMPERATURE_CYPHER")
